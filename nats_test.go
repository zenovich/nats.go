...
var (
	oSeed = []byte("50400b61c0e6b1a7429e369c0c222ab1fbd353816ca5717a0dea1a14198eac36e1018ec5c9d0e37e3aa282")
	aSeed = []byte("5a183a403bb41b6fbd98c87b4ac8d27807bce1305c2a56855543c631f0e7b5314840a3a1890f3ee4ef4b6f")
	uSeed = []byte("59fba30e79bb91aefa8cdaaa86d7eb64d3f2257b213c05e44a7269d8b38cd2f35e4d7cd64a56fa0e0e0fd3")

	aJWT = "eyJ0eXAiOiJqd3QiLCJhbGciOiJzZWNwMjU2azEifQ..9PsZ7FyqfMQF2WKMCtDLF-IfVOO2xcEd44mB_YCbYpsCxblMT2D1ioUB0x9ebyrjNwIdSGHUfPi-j4LKN6epBw"

	uJWT = "eyJ0eXAiOiJqd3QiLCJhbGciOiJzZWNwMjU2azEifQ..cq8qwasaAc4ewKzP3FzEgN2wJkwejG4JFW8JnmxkG7s0__3egiR4uTQ9WuEgSibipWdUhfpFmHUDpNnTBUqA9Q"

	chained = `
-----BEGIN NATS USER JWT-----
eyJ0eXAiOiJqd3QiLCJhbGciOiJzZWNwMjU2azEifQ..cq8qwasaAc4ewKzP3FzEgN2wJkwejG4JFW8JnmxkG7s0__3egiR4uTQ9WuEgSibipWdUhfpFmHUDpNnTBUqA9Q
------END NATS USER JWT------
...
59fba30e79bb91aefa8cdaaa86d7eb64d3f2257b213c05e44a7269d8b38cd2f35e4d7cd64a56fa0e0e0fd3
------END USER NKEY SEED------
`
)
...
func TestNkeyAuth(t *testing.T) {
	...
	seed := []byte("5907fad0908fb921de7d81a2ebcf2cdef2fe10d110cebfa9650d3f329e70d282ff2f023b6d04b8729a4867")
...
func TestNKeyOptionFromSeed(t *testing.T) {
	...
	seedFile = createTmpFile(t, []byte(`
		...
		59BADSEED
	`))
	// Make sure that we detect 59 (trim space) but it still fails because
